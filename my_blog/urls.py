...
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, UserPostListView, PostLikeToggle, SciencePostListView, FictionPostListView
from . import views
